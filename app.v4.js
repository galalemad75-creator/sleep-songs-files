...
const DEFAULT_CHAPTERS = [
    ...
    { id: 4, name: 'Starry Night', icon: '⭐', songs: [] },
    { id: 5, name: 'Butterfly Dreams', icon: '🦋', songs: [] },
    { id: 6, name: 'Forest Whispers', icon: '🌲', songs: [] },
    { id: 7, name: 'Dreamy Waves', icon: '🌊', songs: [] },
    { id: 8, name: 'Cozy Cabin', icon: '🏠', songs: [] },
    { id: 9, name: 'Silky Clouds', icon: '☁️', songs: [] },
    { id: 10, name: 'Meadow Breeze', icon: '🍃', songs: [] },
    { id: 11, name: 'Little Fireflies', icon: '✨', songs: [] },
    { id: 12, name: 'Gentle Snowflakes', icon: '❄️', songs: [] },
    { id: 13, name: 'The Quiet Stream', icon: '🏞️', songs: [] },
    { id: 14, name: 'Autumn Leaves', icon: '🍂', songs: [] },
    { id: 15, name: 'Happy Kittens', icon: '🐱', songs: [] },
    { id: 16, name: 'Moonlit Garden', icon: '🌺', songs: [] },
    { id: 17, name: 'Dreamy Nights', icon: '🌃', songs: [] },
    { id: 18, name: 'Little Stars', icon: '🌟', songs: [] },
    { id: 19, name: 'Teddy Bear Dreams', icon: '🧸', songs: [] },
    { id: 20, name: 'Soft Rain', icon: '🌧️', songs: [] },
    { id: 21, name: 'Sweet Butterfly', icon: '🦋', songs: [] },
    { id: 22, name: 'The Dreamland Train', icon: '🚂', songs: [] },
    { id: 23, name: 'Ocean Waves', icon: '🌊', songs: [] },
    { id: 24, name: 'Soft Clouds', icon: '☁️', songs: [] },
    { id: 25, name: 'Nighttime Fireflies', icon: '✨', songs: [] },
    { id: 26, name: 'Magical Moonlight', icon: '🌕', songs: [] },
    { id: 27, name: 'Cozy Blanket', icon: '🛏️', songs: [] },
    { id: 28, name: 'Starry Night', icon: '⭐', songs: [] },
    { id: 29, name: 'Gentle Rain', icon: '🌧️', songs: [] },
    { id: 30, name: 'Sleepy Train', icon: '🚂', songs: [] },
    { id: 31, name: 'Only Music', icon: '🎼', songs: [], isMusic: true },
    { id: 32, name: 'Only Music 2', icon: '🎼', songs: [], isMusic: true }
];
...
// ===== Original Chapter Order (factory default) =====
const ORIGINAL_CHAPTERS_ORDER = [
    ...
    { name: 'Butterfly Dreams', icon: '🦋' },
    { name: 'Forest Whispers', icon: '🌲' },
    { name: 'Dreamy Waves', icon: '🌊' },
    { name: 'Cozy Cabin', icon: '🏠' },
    { name: 'Silky Clouds', icon: '☁️' },
    { name: 'Meadow Breeze', icon: '🍃' },
    { name: 'Little Fireflies', icon: '✨' },
    { name: 'Gentle Snowflakes', icon: '❄️' },
    { name: 'The Quiet Stream', icon: '🏞️' },
    { name: 'Autumn Leaves', icon: '🍂' },
    { name: 'Happy Kittens', icon: '🐱' },
    { name: 'Moonlit Garden', icon: '🌺' },
    { name: 'Dreamy Nights', icon: '🌃' },
    { name: 'Little Stars', icon: '🌟' },
    { name: 'Teddy Bear Dreams', icon: '🧸' },
    { name: 'Soft Rain', icon: '🌧️' },
    { name: 'Sweet Butterfly', icon: '🦋' },
    { name: 'The Dreamland Train', icon: '🚂' },
    { name: 'Ocean Waves', icon: '🌊' },
    { name: 'Soft Clouds', icon: '☁️' },
    { name: 'Nighttime Fireflies', icon: '✨' },
    { name: 'Magical Moonlight', icon: '🌕' },
    { name: 'Cozy Blanket', icon: '🛏️' },
    { name: 'Starry Night', icon: '⭐' },
    { name: 'Gentle Rain', icon: '🌧️' },
    { name: 'Sleepy Train', icon: '🚂' },
    { name: 'Only Music', icon: '🎼' },
    { name: 'Only Music 2', icon: '🎼' }
];
...
async function uploadFile(file, oldUrl) {
    // Refresh GITHUB_CONFIG from localStorage (user may have saved token after page load)
    ...
    if (!GITHUB_CONFIG.token) {
        toast('Please set your GitHub Token in Settings first!', 'error');
    ...
    if (!res.ok) {
        ...
        throw new Error(errData.message || `GitHub upload failed: ${res.status}`);
    }
