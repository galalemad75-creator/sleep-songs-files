...
DROP POLICY IF EXISTS "Allow anon read chapters" ON public.chapters;
DROP POLICY IF EXISTS "Allow anon read settings" ON public.settings;
DROP POLICY IF EXISTS "Allow anon write chapters" ON public.chapters;
DROP POLICY IF EXISTS "Allow anon write settings" ON public.settings;
